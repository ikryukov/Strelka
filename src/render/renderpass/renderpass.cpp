...
void RenderPass::onResize(VkImageView& imageView, VkImageView& depthImageView, uint32_t width, uint32_t height)
{
    mWidth = width;
    mHeight = height;
    ...
    createFrameBuffers(imageView, depthImageView, mWidth, mHeight);
}
