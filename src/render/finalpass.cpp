...
void FinalPass::createComputePipeline(VkShaderModule& shaderModule)
{
...
VkShaderModule FinalPass::createShaderModule(const char* code, const uint32_t codeSize)
{
...
void FinalPass::createDescriptorSetLayout()
{
    ...
    samplerLayoutBinding.pImmutableSamplers = nullptr; //mTextureSamplers.data();
...
void FinalPass::createDescriptorSets(VkDescriptorPool& descriptorPool)
{
...
void FinalPass::updateDescriptorSet(uint32_t descIndex)
{
    ...
    descriptorWrites[11].pBufferInfo = &lightInfo;
    ...
    descriptorWrites[12].pImageInfo = &imageShadowInfo;
    ...
    descriptorWrites[13].descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_IMAGE;
...
void FinalPass::updateDescriptorSets()
{
...
void FinalPass::record(VkCommandBuffer& cmd, uint32_t width, uint32_t height, uint32_t imageIndex)
{
...
void FinalPass::updateUniformBuffer(uint32_t currentImage, Scene& scene, uint32_t cameraIndex, const uint32_t width, const uint32_t height)
{
...
void FinalPass::setMaterialBuffer(VkBuffer materialBuffer)
{
...
void FinalPass::setInstanceBuffer(VkBuffer instanceBuffer)
{
...
void FinalPass::setLightBuffer(VkBuffer lightBuffer)
{
...
void FinalPass::setGbuffer(GBuffer* gbuffer)
{
    mGbuffer = gbuffer;
    for (int i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
    {
...
void FinalPass::setRtShadowImageView(VkImageView imageView)
{
...
void FinalPass::setLtcImageView(VkImageView imageView)
{
...
void FinalPass::setOutputImageView(VkImageView imageView)
{
...
void FinalPass::setTextureSamplers(std::vector<VkSampler>& textureSamplers)
{
...
void FinalPass::setTextureImageViews(const std::vector<VkImageView>& texImages)
{
...
void FinalPass::init(VkDevice& device, const char* csCode, uint32_t csCodeSize, VkDescriptorPool descpool, ResourceManager* resMngr)
{
    mDevice = device;
    mResManager = resMngr;
