...
public:
    ...
    void updateUI(Scene& scene, double msPerFrame, std::string& newModelPath, uint32_t& selectedCamera, float& animTime, bool& enableAcc, float& accAlpha, float& sigma, int& radius, int& maxR);
