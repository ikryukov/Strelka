...
public:
    ...
    void updateUI(Scene& scene, double msPerFrame, std::string& newModelPath, uint32_t& selectedCamera, float& animTime, float& sigma, int& radius, int& maxR);
    void updateUI(Scene& scene, double msPerFrame, std::string& newModelFile, uint32_t& selectedCamera, float& animTime, bool& enableAcc, float& accAlpha);
